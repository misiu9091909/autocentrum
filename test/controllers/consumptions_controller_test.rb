...
class ConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post :create, consumption: { average: @consumption.average, count: @consumption.count, fuel_type: @consumption.fuel_type, max: @consumption.max, min: @consumption.min, min_long: @consumption.min_long, official: @consumption.official }
    end
  ...
  test "should update consumption" do
    patch :update, id: @consumption, consumption: { average: @consumption.average, count: @consumption.count, fuel_type: @consumption.fuel_type, max: @consumption.max, min: @consumption.min, min_long: @consumption.min_long, official: @consumption.official }
    assert_redirected_to consumption_path(assigns(:consumption))
  end
